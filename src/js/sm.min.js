...
! function ($) {
  "use strict";
  var show = false;
  var $switch = $(".js-hover-item");
  var hoverPanel = $(".hover-panel");
  var prop = $(".prodProp");
  $switch.on("click", function () {
    $("body").hasClass("open") && $switch.hasClass("show") ?
      $switch.removeClass("show") && $("body").removeClass("open") && $(".mask").hide() :
      $switch.addClass("show") && $("body").addClass("open") && $(".mask").show();
  })

  $(".js-prop-show").on("click", function () {
    $("body").hasClass("open") && $(this).hasClass("show") ?
      $(this).removeClass("show") && $("body").removeClass("open") && $(".mask").hide() :
      $(this).addClass("show") && $("body").addClass("open") && $(".mask").show();
  })
...
function ($) {
  ...
  $.closeModal = function (modal) {
    ...
    var isModal = modal.hasClass('modal'),
      ...
      isHeroModal = modal.hasClass('hero-modal'),
      isHeroModal2 = modal.hasClass('hero-modal2'),
      isLoginScreen = modal.hasClass('login-screen'),
      isPickerModal = modal.hasClass('picker-modal'),
      isPropsActions = modal.hasClass("props-modal"),
    ...
    modal.removeClass('modal-in').addClass('modal-out').transitionEnd(function (e) {
      ...
      if (isPopup || isLoginScreen || isPickerModal || isHeroModal || isPropsActions || isHeroModal2) {
  ...
  $.heroModal = function(modal, clickedData,removeOnClose){
    ...
    if(clickedData.autoid){
      var autoid = clickedData.autoid;
      var links = $('#guihuan').find('a');
      for(var i = 0; i < links.length; i++){
        var href = $(links[i]).attr("href");
        $(links[i]).attr("href",href.replace(/oid=\w*/,"oid="+autoid+""));
      }
    }
    ...
    if (modal.length === 0) return false;
    modal.show();
    modal.trigger('opend', [clickedData]);
    $.openModal(modal);
    return modal[0];
  }
  ...
  function handleClicks(e) {
    ...
    // hero-modal
    var heroModal;
    if (clicked.hasClass('open-heroModal')) {
      if (clickedData.modal) {
        heroModal = clickedData.modal;
      } else heroModal = '.hero-modal';
      $.heroModal(heroModal, clickedData);
    }
    if (clicked.hasClass('close-heroModal')) {
      if (clickedData.modal) {
        heroModal = clickedData.modal;
      } else heroModal = '.hero-modal.modal-in';
      $.closeModal(heroModal);
    }


    var actionsModal;
    if (clicked.hasClass('open-actions')) {
      if (clickedData.popup) {
        actionsModal = clickedData.modal;
      } else actionsModal = '.props-modal';
      $.propsActions(actionsModal);
    }
    if (clicked.hasClass('close-propsActions')) {
      if (clickedData.modal) {
        actionsModal = clickedData.modal;
      } else actionsModal = '.props-modal.modal-in';
      $.closeModal(actionsModal);
    }


  }
  $(document).on('click', ' .modal-overlay, .popup-overlay, .close-popup, .open-popup, .close-picker, .open-heroModal, .close-heroModal, .open-actions, .close-propsActions', handleClicks);
...
function ($) {
  ...
  $.openPanel = function (panel) {
    ...
    $(".mask").show();
    $(".js-hover-item").removeClass("show");
    $("body").removeClass("open");
